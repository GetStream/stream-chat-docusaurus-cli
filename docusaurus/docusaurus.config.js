...
const findCustomPluginIndex = (pluginId) =>
  CUSTOM_PLUGINS.findIndex((plugin) => plugin[0] === pluginId);
const extractCustomPlugin = (pluginId) =>
  CUSTOM_PLUGINS.splice(findCustomPluginIndex(pluginId), 1).pop();
...
navbarItems.push(...navbarVersionItems, ...navbarGithubItems);
