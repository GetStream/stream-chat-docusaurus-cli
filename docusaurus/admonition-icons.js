...
const info = '<svg width="15" height="15" viewBox="0 0 15 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M7.5 14.6A7 7 0 117.5.4a7 7 0 010 14.2zM4.7 8.2a2.8 2.8 0 105.6 0H4.7zm0-1.4a1 1 0 100-2.1 1 1 0 000 2zm5.6 0a1 1 0 100-2.1 1 1 0 000 2z"/></svg>';
